package uk.gov.justice.digital.hmpps.jobsboardintegrationapi.resource
...
import uk.gov.justice.digital.hmpps.jobsboardintegrationapi.service.ExampleApiService
...
class ExampleResource(private val exampleApiService: ExampleApiService) {
  ...
  @Operation(
    ...
    security = [SecurityRequirement(name = "jobs-board-integration-api-ui-role")],
    responses = [
